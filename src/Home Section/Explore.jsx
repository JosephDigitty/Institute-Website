    ...
    <div className='h-fit w-full bg-cover  bg-gray-100'>
        ...
        <div>
            ...
            <div className='flex flex-col'>
                <a className='font-ptserif text-center font-bold py-3 text-gradient-M text-base lg:text-center lg:text-2xl' href="/become-a-member">Membership</a>
            ...
            <div className='flex flex-col lg:flex-row items-center bg-white gap-4 p-4 border rounded-lg shadow-md hover:shadow-lg/lg'>
            <div className='flex flex-col'>
            <a className='font-ptserif text-center font-bold py-3 text-gradient-M text-base lg:text-center lg:text-2xl' href="/Training">Training</a>
                <p className='font-ptserif text-center text-sm lg:text-[15px]  lg:leading-[30px]' >
            ...
            <div className='flex flex-col'>
            <a className='font-ptserif text-center font-bold py-3 text-base text-gradient-M lg:text-center lg:text-2xl' href="/research">Research</a>
                <p className='font-ptserif text-center text-sm lg:text-[15px]  lg:leading-[30px]' >
            ...
            <div className="flex flex-col lg:flex-row items-center bg-white justify-between gap-6 p-4 border rounded-lg shadow-md hover:shadow-lg/lg"> 
            <div className='flex flex-col'>
            <a className='font-ptserif text-center font-bold py-3 text-base text-gradient-M lg:text-center lg:text-2xl' href="/consultancy">Consultancy</a>
                <p className='font-ptserif text-center text-sm lg:text-[15px]  lg:leading-[30px]' >
            ...
            <div className="flex flex-col lg:flex-row items-center bg-white justify-between gap-6 p-4 border rounded-lg shadow-md hover:shadow-lg/lg">
            <div className='flex flex-col'>
            <a className='font-ptserif text-center font-bold py-3 text-gradient-M text-base lg:text-center lg:text-2xl' href="/news">Conferences</a>
            ...
            <div className="flex flex-col lg:flex-row items-center bg-white justify-between gap-6 p-4 border rounded-lg shadow-md hover:shadow-lg/lg">
            <div className='flex flex-col'>
            <a className='font-ptserif text-center font-bold py-3 text-gradient-M text-base lg:text-center lg:text-2xl' href="/Articles">Knowledge</a>
                <p className='font-ptserif text-center text-sm lg:text-[15px]  lg:leading-[30px]'>
